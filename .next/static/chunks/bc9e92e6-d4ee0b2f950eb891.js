"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[358],{5002:function(e,t,r){r.d(t,{JU:function(){return ib},PL:function(){return sr},QT:function(){return se},ad:function(){return ix},hJ:function(){return ik},qs:function(){return ss}});var n,i,s,a,o=r(9279),l=r(2680),u=r(9053),h=r(3943),c=r(6552),d=r(4575);r(357);var f=r(6300).Buffer;let m="@firebase/firestore";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function r3(e){return new t7(e,!0)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let iq=/^__.*__$/;class iB{constructor(e,t,r){this.data=e,this.fieldMask=t,this.fieldTransforms=r}toMutation(e,t){return null!==this.fieldMask?new tM(e,this.data,this.fieldMask,t,this.fieldTransforms):new tV(e,this.data,t,this.fieldTransforms)}}class iz{constructor(e,t,r){this.data=e,this.fieldMask=t,this.fieldTransforms=r}toMutation(e,t){return new tM(e,this.data,this.fieldMask,t,this.fieldTransforms)}}function i$(e){switch(e){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw I()}}class iK{constructor(e,t,r,n,i,s){this.settings=e,this.databaseId=t,this.serializer=r,this.ignoreUndefinedProperties=n,void 0===i&&this.yu(),this.fieldTransforms=i||[],this.fieldMask=s||[]}get path(){return this.settings.path}get wu(){return this.settings.wu}Su(e){return new iK(Object.assign(Object.assign({},this.settings),e),this.databaseId,this.serializer,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}bu(e){var t;let r=null===(t=this.path)||void 0===t?void 0:t.child(e),n=this.Su({path:r,Du:!1});return n.vu(e),n}Cu(e){var t;let r=null===(t=this.path)||void 0===t?void 0:t.child(e),n=this.Su({path:r,Du:!1});return n.yu(),n}Fu(e){return this.Su({path:void 0,Du:!0})}Mu(e){return i0(e,this.settings.methodName,this.settings.xu||!1,this.path,this.settings.Ou)}contains(e){return void 0!==this.fieldMask.find(t=>e.isPrefixOf(t))||void 0!==this.fieldTransforms.find(t=>e.isPrefixOf(t.field))}yu(){if(this.path)for(let e=0;e<this.path.length;e++)this.vu(this.path.get(e))}vu(e){if(0===e.length)throw this.Mu("Document fields must not be empty");if(i$(this.wu)&&iq.test(e))throw this.Mu('Document fields cannot begin and end with "__"')}}class iQ{constructor(e,t,r){this.databaseId=e,this.ignoreUndefinedProperties=t,this.serializer=r||r3(e)}Nu(e,t,r,n=!1){return new iK({wu:e,methodName:t,Ou:r,path:$.emptyPath(),Du:!1,xu:n},this.databaseId,this.serializer,this.ignoreUndefinedProperties)}}class iG extends iF{_toFieldTransform(e){if(2!==e.wu)throw 1===e.wu?e.Mu(`${this._methodName}() can only appear at the top level of your update data`):e.Mu(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);return e.fieldMask.push(e.path),null}isEqual(e){return e instanceof iG}}function ij(e,t){if(iH(e=(0,h.m9)(e)))return iY("Unsupported field value:",t,e),iW(e,t);if(e instanceof iF)return function(e,t){if(!i$(t.wu))throw t.Mu(`${e._methodName}() can only be used with update() and set()`);if(!t.path)throw t.Mu(`${e._methodName}() is not currently supported inside arrays`);let r=e._toFieldTransform(t);r&&t.fieldTransforms.push(r)}(e,t),null;if(void 0===e&&t.ignoreUndefinedProperties)return null;if(t.path&&t.fieldMask.push(t.path),e instanceof Array){if(t.settings.Du&&4!==t.wu)throw t.Mu("Nested arrays are not supported");return function(e,t){let r=[],n=0;for(let i of e){let e=ij(i,t.Fu(n));null==e&&(e={nullValue:"NULL_VALUE"}),r.push(e),n++}return{arrayValue:{values:r}}}(e,t)}return function(e,t){var r,n,i;if(null===(e=(0,h.m9)(e)))return{nullValue:"NULL_VALUE"};if("number"==typeof e)return r=t.serializer,"number"==typeof(i=n=e)&&Number.isInteger(i)&&!J(i)&&i<=Number.MAX_SAFE_INTEGER&&i>=Number.MIN_SAFE_INTEGER?tp(n):tg(r,n);if("boolean"==typeof e)return{booleanValue:e};if("string"==typeof e)return{stringValue:e};if(e instanceof Date){let r=P.fromDate(e);return{timestampValue:rt(t.serializer,r)}}if(e instanceof P){let r=new P(e.seconds,1e3*Math.floor(e.nanoseconds/1e3));return{timestampValue:rt(t.serializer,r)}}if(e instanceof iP)return{geoPointValue:{latitude:e.latitude,longitude:e.longitude}};if(e instanceof iM)return{bytesValue:rr(t.serializer,e._byteString)};if(e instanceof iN){let r=t.databaseId,n=e.firestore._databaseId;if(!n.isEqual(r))throw t.Mu(`Document reference is for database ${n.projectId}/${n.database} but should be for database ${r.projectId}/${r.database}`);return{referenceValue:ri(e.firestore._databaseId||t.databaseId,e._key.path)}}if(e instanceof iU)return{mapValue:{fields:{__type__:{stringValue:"__vector__"},value:{arrayValue:{values:e.toArray().map(e=>{if("number"!=typeof e)throw t.Mu("VectorValues must only contain numeric values.");return tg(t.serializer,e)})}}}}};throw t.Mu(`Unsupported field value: ${iE(e)}`)}(e,t)}function iW(e,t){let r={};return et(e)?t.path&&t.path.length>0&&t.fieldMask.push(t.path):ee(e,(e,n)=>{let i=ij(n,t.bu(e));null!=i&&(r[e]=i)}),{mapValue:{fields:r}}}function iH(e){return!("object"!=typeof e||null===e||e instanceof Array||e instanceof Date||e instanceof P||e instanceof iP||e instanceof iM||e instanceof iN||e instanceof iF||e instanceof iU)}function iY(e,t,r){if(!iH(r)||!("object"==typeof r&&null!==r&&(Object.getPrototypeOf(r)===Object.prototype||null===Object.getPrototypeOf(r)))){let n=iE(r);throw"an object"===n?t.Mu(e+" a custom object"):t.Mu(e+" "+n)}}function iX(e,t,r){if((t=(0,h.m9)(t))instanceof iO)return t._internalPath;if("string"==typeof t)return iZ(e,t);throw i0("Field path arguments must be of type string or ",e,!1,void 0,r)}let iJ=RegExp("[~\\*/\\[\\]]");function iZ(e,t,r){if(t.search(iJ)>=0)throw i0(`Invalid field path (${t}). Paths must not contain '~', '*', '/', '[', or ']'`,e,!1,void 0,r);try{return new iO(...t.split("."))._internalPath}catch(n){throw i0(`Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,e,!1,void 0,r)}}function i0(e,t,r,n,i){let s=n&&!n.isEmpty(),a=void 0!==i,o=`Function ${t}() called with invalid data`;r&&(o+=" (via `toFirestore()`)"),o+=". ";let l="";return(s||a)&&(l+=" (found",s&&(l+=` in field ${n}`),a&&(l+=` in document ${i}`),l+=")"),new S(C.INVALID_ARGUMENT,o+e+l)}function i1(e,t){return e.some(e=>e.isEqual(t))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function se(e){e=iT(e,iN);let t=iT(e.firestore,iR);return(function(e,t,r={}){let n=new N;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,r,n,i){let s=new il({next:s=>{t.enqueueAndForget(()=>nO(e,a));let o=s.docs.has(r);!o&&s.fromCache?i.reject(new S(C.UNAVAILABLE,"Failed to get document because the client is offline.")):o&&s.fromCache&&n&&"server"===n.source?i.reject(new S(C.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):i.resolve(s)},error:e=>i.reject(e)}),a=new nq(new e9(r.path),s,{includeMetadataChanges:!0,_a:!0});return nM(e,a)})(await ig(e),e.asyncQueue,t,r,n)),n.promise})(iL(t),e._key).then(r=>(function(e,t,r){let n=r.docs.get(t._key),i=new st(e);return new i5(e,i,t._key,n,new i8(r.hasPendingWrites,r.fromCache),t.converter)})(t,e,r))}class st extends i9{constructor(e){super(),this.firestore=e}convertBytes(e){return new iM(e)}convertReference(e){let t=this.convertDocumentKey(e,this.firestore._databaseId);return new iN(this.firestore,null,t)}}function sr(e){e=iT(e,iS);let t=iT(e.firestore,iR),r=iL(t),n=new st(t);return(/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sn{constructor(e,t){this._firestore=e,this._commitHandler=t,this._mutations=[],this._committed=!1,this._dataReader=function(e){let t=e._freezeSettings(),r=r3(e._databaseId);return new iQ(e._databaseId,!!t.ignoreUndefinedProperties,r)}(e)}set(e,t,r){var n;this._verifyNotCommitted();let i=si(e,this._firestore),s=(n=i.converter)?r&&(r.merge||r.mergeFields)?n.toFirestore(t,r):n.toFirestore(t):t,a=function(e,t,r,n,i,s={}){let a,o;let l=e.Nu(s.merge||s.mergeFields?2:0,t,r,i);iY("Data must be an object, but it was:",l,n);let u=iW(n,l);if(s.merge)a=new eo(l.fieldMask),o=l.fieldTransforms;else if(s.mergeFields){let e=[];for(let n of s.mergeFields){let i=iX(t,n,r);if(!l.contains(i))throw new S(C.INVALID_ARGUMENT,`Field '${i}' is specified in your field mask but missing from your input data.`);i1(e,i)||e.push(i)}a=new eo(e),o=l.fieldTransforms.filter(e=>a.covers(e.field))}else a=null,o=l.fieldTransforms;return new iB(new eM(u),a,o)}(this._dataReader,"WriteBatch.set",i._key,s,null!==i.converter,r);return this._mutations.push(a.toMutation(i._key,tk.none())),this}update(e,t,r,...n){let i;this._verifyNotCommitted();let s=si(e,this._firestore);return i="string"==typeof(t=(0,h.m9)(t))||t instanceof iO?function(e,t,r,n,i,s){let a=e.Nu(1,t,r),o=[iX(t,n,r)],l=[i];if(s.length%2!=0)throw new S(C.INVALID_ARGUMENT,`Function ${t}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let e=0;e<s.length;e+=2)o.push(iX(t,s[e])),l.push(s[e+1]);let u=[],c=eM.empty();for(let e=o.length-1;e>=0;--e)if(!i1(u,o[e])){let t=o[e],r=l[e];r=(0,h.m9)(r);let n=a.Cu(t);if(r instanceof iG)u.push(t);else{let e=ij(r,n);null!=e&&(u.push(t),c.set(t,e))}}return new iz(c,new eo(u),a.fieldTransforms)}(this._dataReader,"WriteBatch.update",s._key,t,r,n):function(e,t,r,n){let i=e.Nu(1,t,r);iY("Data must be an object, but it was:",i,n);let s=[],a=eM.empty();return ee(n,(e,n)=>{let o=iZ(t,e,r);n=(0,h.m9)(n);let l=i.Cu(o);if(n instanceof iG)s.push(o);else{let e=ij(n,l);null!=e&&(s.push(o),a.set(o,e))}}),new iz(a,new eo(s),i.fieldTransforms)}(this._dataReader,"WriteBatch.update",s._key,t),this._mutations.push(i.toMutation(s._key,tk.exists(!0))),this}delete(e){this._verifyNotCommitted();let t=si(e,this._firestore);return this._mutations=this._mutations.concat(new tU(t._key,tk.none())),this}commit(){return this._verifyNotCommitted(),this._committed=!0,this._mutations.length>0?this._commitHandler(this._mutations):Promise.resolve()}_verifyNotCommitted(){if(this._committed)throw new S(C.FAILED_PRECONDITION,"A write batch can no longer be used after commit() has been called.")}}function si(e,t){if((e=(0,h.m9)(e)).firestore!==t)throw new S(C.INVALID_ARGUMENT,"Provided document reference is from a different Firestore instance.");return e}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
